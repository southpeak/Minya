...
typedef NS_ENUM(NSInteger, FKFlickrFavoritesAddError) {
	...
	FKFlickrFavoritesAddError_SSLIsRequired = 95,		 /* SSL is required to access the Flickr API. */
	...
	FKFlickrFavoritesAddError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
