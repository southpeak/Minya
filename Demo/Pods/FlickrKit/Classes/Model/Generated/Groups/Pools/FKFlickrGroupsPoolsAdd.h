...
typedef NS_ENUM(NSInteger, FKFlickrGroupsPoolsAddError) {
	...
	FKFlickrGroupsPoolsAddError_SSLIsRequired = 95,		 /* SSL is required to access the Flickr API. */
	...
	FKFlickrGroupsPoolsAddError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
